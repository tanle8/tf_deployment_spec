...
function getModel() {
    ...
    // flatten, and dense.
    // Since the Fashion MNIST has 10 classes, your output layer
    // should have 10 units and a softmax activation function.
    // You are free to use as many layers, filters, and neurons as you like.  
...
async function train(model, data) {
    ...
    const container = { name: 'Model Training', style: { height: '1000px' } }
